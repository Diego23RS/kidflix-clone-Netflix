...
var filmes = {
    ...
    listaCartoon : [["pocoyo","Pocoyo","img/pocoyo.jpg","Acompanhe o pequeno Pocoyo em suas aventuras e descobertas, nesta vibrante série animada para crianças em idade pré-escolar."],
    ["bobzoom","Bob Zoom","img/bobzoom.jpg","A adorável formiga Bob Zoom e seus colegas de classe estimulam a imaginação das crianças com canções e jogos que ajudam a desenvolver habilidades fundamentais."],
    ["bitaanimais","Bita e os Animais","img/bitaanimais.jpg","Bita e seus amigos estão prontos para explorar o céu, o oceano, as florestas, a savana e outros lugares do mundo ricos em fauna e flora. Tudo isso com muita música!"],
    ["galinhapintadinha","Galinha Pintadinha","img/galinhapintadinha.jpg","Animações com canções brasileiras que educam as crianças. Galinha Pintadinha e sua Turma é uma produção 100% brasileira que traz cultura e diversão em desenho animado."],
    ["palavrinhas","3 Palavrinhas","img/palavrinhas.jpg","Animações coloridas e músicas divertidas incentivam as crianças a dançar e cantar canções sobre fé."],
    ["taina","Tainá e os Guardiões da Amazônia","img/taina.jpg","Uma corajosa indiazinha explora a Floresta Amazônica com seus amigos animais para proteger a vida selvagem e suas maravilhas."],
    ]
